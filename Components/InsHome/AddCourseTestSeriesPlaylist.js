...
import {addCourseTestSeriesPlaylist} from '../Utils/DataHelper/Course'
import Toast from 'react-native-simple-toast';

class AddCourseTestSeriesPlaylist extends Component { 
    state=
    {
        name:'',
    }
    ...
    handleAddPlaylistClick=() =>
    {
        if(this.verify(this.state))
        {
            ...
            addCourseTestSeriesPlaylist(this.state.name,this.props.courseId,this.handleAddPlaylistCallBack)
        }else
        {
        ...
        <Modal 
            ...
            <ScrollView>
                <View style={styles.headView}>
                    <Text style={styles.headText}>Add Test Series Playlist</Text>
                </View>
...
export default AddCourseTestSeriesPlaylist;
