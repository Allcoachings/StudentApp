            ...
            <>
                <ScrollView style={{ height: height }}>
                    <View style={styles.container}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            {this.renderButton(Assets.profile.policy, 'Privacy & Policy', () => { this.props.navigation.navigate('Policy') })}
                            {this.renderButton(Assets.profile.about, 'About Us', () => { this.props.navigation.navigate('About') })}
                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            {this.renderButton(Assets.profile.refund, 'Refund Policy', () => { this.props.navigation.navigate('Refund') })}
                            {this.renderButton(Assets.profile.contact, 'Contact Us', () => { this.props.navigation.navigate('Contact') })}
                        </View>
                        <View style={{ marginVertical: 10, height: 10, borderTopWidth: 8, borderColor: theme.labelOrInactiveColor + '66' }} />
