        ...
        switch (activeTab) {
            case 1:
                return(
                    ...
                    {this.renderPurchageCourse('NIT classes')}
                    {this.renderPurchageCourse('Arth Institute')}
                    </View>
                ...
                <ScrollView>
                    <View style={styles.container}>
                        ...
                        <View style={styles.profile_navigation}>
                                <View>
                                    <Text style={styles.navlink} onPress={()=>{this.activeTab(1)}}>Purchage</Text>
                                </View>
                                <View>
                                    <Text style={styles.navlink} onPress={()=>{this.activeTab(2)}}>History</Text>
                                </View>
                                <View>
                                    <Text style={styles.navlink} onPress={()=>{this.activeTab(3)}}>Feed</Text>
                                </View>
                        </View>
