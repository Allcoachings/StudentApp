...
function Comments({videoId,unshiftCommets,comments,setIsCommentsVisible,setIsSideScreenVisible,height,width,flatlistHeight,showCloseIcon}) {
        ...
        <View style={{width,height}}> 
            ...
            <View style={{flex:1}}>
                ...
                <View style={{flex:0.15}}>
                    <AddComment videoId={videoId} unshiftCommets={unshiftCommets}/>
                </View>
            {/* </View> */}
            </View>
